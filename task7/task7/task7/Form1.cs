...
namespace task7
{
    public partial class Form1 : Form
    {
        ...
        private void canvas_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                // Проверяем клик по фигуре для перетаскивания
        ...
        private void CreateFigure(Point start, Point end)
        {
            ...
            switch (currentFigureType)
            {
                ...
                case FigureType.Rectangle:
                    ...
                    break;
                case FigureType.LShape:
                    f = new LShape(x, y, w, h);
                    break;
                case FigureType.UShape:
                    f = new UShape(x, y, w, h);
                    break;
            }
        ...
        private void UpdateToolbar()
        {
            ...
            lShapeButton.Checked = currentFigureType == FigureType.LShape;
            uShapeButton.Checked = currentFigureType == FigureType.UShape;
        ...
        private void lShapeToolStripMenuItem_Click(object sender, EventArgs e) { SetFigureType(FigureType.LShape); }
        private void uShapeToolStripMenuItem_Click(object sender, EventArgs e) { SetFigureType(FigureType.UShape); }
        ...
        // ✅ Добавляем пункт меню для заливки
        ...
        // ✅ Добавляем пункт меню для отключения заливки
        ...
        {
            fillColorToolStripMenuItem_Click(sender, e);
        }
        ...
        private void lShapeButton_Click(object sender, EventArgs e) { lShapeToolStripMenuItem_Click(sender, e); }
        private void uShapeButton_Click(object sender, EventArgs e) { uShapeToolStripMenuItem_Click(sender, e); }
    ...
    public enum FigureType { Select, Square, Rectangle, LShape, UShape }
}