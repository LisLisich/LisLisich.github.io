...
namespace task7
{
    ...
    public class LShape : Figure
    {
        ...
        public LShape() : base() { }
        public LShape(int x, int y, int width, int height, int thickness = 30) : base(x, y, width, height)
        {
        ...
        public override string GetTypeName() => "Г-образная фигура";
    }
}